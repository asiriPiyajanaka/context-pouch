...
files = ['package.json', 'README.md', 'extension.js', 'library.js', 'sqlite-store.js', 'graph-snapshot.js', 'rule-state.js', 'pack-files.js', 'generator.js', 'generation-ui.js', 'patcher.js', 'session-patch.js', 'session-bridge.js', 'session-ui.js', 'model.js', 'client.js', 'runtime.js', 'host-bridge.js', 'webview-bootstrap.js', 'media/graph.js', 'media/graph-model.js', 'media/graph-renderer.js', 'media/graph-explorer.js', 'media/graph-inspector.js', 'media/node-graph.css', 'media/library-view.js', 'media/library-dialogs.js', 'media/graph.css', 'media/pouch.svg']
