...
files = ['package.json', 'README.md', 'extension.js', 'library.js', 'patcher.js', 'model.js', 'client.js', 'runtime.js', 'host-bridge.js', 'webview-bootstrap.js', 'media/graph.js', 'media/graph.css', 'media/pouch.svg']
